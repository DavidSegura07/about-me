...
function userGuessCorrectCars() {
  ...
  for (let i = 0; i < attemptsToGo; i++) {
    ...
    if (userGuessCorrect === false && attemptsToGo > 0) {
      console.log(`No try again. You have  ${attemptsToGo - i - 1}   left.`);
      alert(`No try again. You have  ${attemptsToGo - i - 1}   left.`);
    }
  }
}

userGuessCorrectCars();

let totalPoint = userPoints;
console.log(totalPoint);
alert (`you got ${totalPoint} correct out of 7 questions asked`);
